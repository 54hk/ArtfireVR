...
//			paint.setColor(Color.rgb(33, 65, 98));
            paint.setColor(getResources().getColor(R.color.text_ccab86));
            ...
            canvas.drawText(b[i], xPos, height / b.length * i +singleHeight/2, paint);
        ...
        if (bg == -1) {
            setBackgroundColor(getResources().getColor(R.color.color_373632));
        } else {
