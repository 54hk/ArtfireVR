...
/**
 * Created by XiChen on 2016/12/27.
 */
...
public class CountDownTimerUtils extends CountDownTimer {
    ...
    public void onTick(long millisUntilFinished) {
        ...
        mTextView.setBackgroundResource(R.drawable.sms_code_bg); //设置按钮为灰色，这时是不能点击的
    ...
    public void onFinish() {
        ...
        mTextView.setBackgroundResource(R.drawable.sms_code_bg);  //还原背景色
    }
