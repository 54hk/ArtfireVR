...
import com.artfire.ninedraw.alive.achieve.ui.fragment.LivePushFragment;
...
public class LivePushActivity extends BaseActivity {
    ...
    public static final String CRID = "crid";//课件ID
...
//        requestWindowFeature(Window.FEATURE_NO_TITLE);
        ...
        AppUtil.keepScreenLongLight(this, true);
...
//        mAlivcLivePushConfig.setCameraType(AlivcLivePushCameraTypeEnum.CAMERA_TYPE_BACK);
        ...
        mLivePushFragment = new LivePushFragment().newInstance(mPushUrl, mAsync, mAudioOnly, mVideoOnly
                , Camera.CameraInfo.CAMERA_FACING_BACK, mFlash, mAlivcLivePushConfig
                        .getQualityMode().getQualityMode(), mAuthTime, mPrivacyKey, mMixExtern, mMixMain, crid);
...
//        registerReceiver(mChangedReceiver, filter);
    ...
    public int setLayoutId() {
        ...
        mCameraId = getIntent().getIntExtra(CAMERA_ID, Camera.CameraInfo.CAMERA_FACING_BACK);
...
//        });
    ...
    public static void startActivity(Activity activity,
                                     ...
                                     String url,
                                     boolean async, // true
                                     boolean audioOnly, //false  自动播放
                                     boolean videoOnly, //false
                                     AlivcPreviewOrientationEnum orientation, //ORIENTATION_LANDSCAPE_HOME_RIGHT
                                     int cameraId, //Camera.CameraInfo.CAMERA_FACING_BACK;
                                     boolean isFlash, //false
                                     String authTime, //""
                                     String privacyKey,//""
                                     boolean mixExtern, //false
                                     boolean mixMain) {
...
//        }
    ...
    protected void onDestroy() {
        AppUtil.keepScreenLongLight(this, false);
        videoThreadOn = false;
        audioThreadOn = false;
        if (mAlivcLivePusher != null) {
            try {
...
//        }
    ...
    public static void startActivity(Activity activity
        ...
        bundle.putInt(ORIENTATION_KEY, 1);
        bundle.putInt(CAMERA_ID, Camera.CameraInfo.CAMERA_FACING_BACK);
...
//                mAlivcLivePushConfig.setNetworkPoorPushImage(Environment.getExternalStorageDirectory().getPath() + File.separator + "alivc_resource/poor_network_land.png");
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK && event.getAction() == KeyEvent.ACTION_DOWN) {
            if (null != mLivePushFragment) {
                mLivePushFragment.exitMothod();
            }
        }
        return false;
    }
