package com.artfire.ninedraw.alive.core.utils.constants;
...
public class BeautyConstants {
    ...
    public static final int DEFAULT_VALUE_INT_BEAUTY_BRIGHTNESS = 60;
    public static final int DEFAULT_VALUE_INT_BEAUTY_BITEYE = 70;
