...
//	private final static int FINE_LOCATION = 103;
	...
	private PermissionModel[] mPermissionModels = new PermissionModel[] {
			new PermissionModel("相机", Manifest.permission.CAMERA, "我们需要相机权限来激活AR", CAMERA),
//			new PermissionModel("位置信息", Manifest.permission.ACCESS_FINE_LOCATION, "我们需要定位权限来确定您的位置", FINE_LOCATION),
			new PermissionModel("存储空间", Manifest.permission.WRITE_EXTERNAL_STORAGE, "我们需要您允许我们读写你的存储卡，以方便我们保存一些数据",
